...
global_warming = pd.read_csv("../../data/nasa.csv")
#global_warming = global_warming[0:80]
...
# ---------------------------------------
bandwidths = np.logspace(np.log10(1), np.log10(50), num=30)
...
for b in range(len(bandwidths)):
    ...
    ax.legend()
    plots.save_plot(f"../../plots/global_warming_bandwidth{b}.png")
    plt.close()
...
# ---------------------------------------
fps = 3
with imageio.get_writer(f"../../plots/global_warming.gif", mode="I", fps=fps) as writer:
    for b in range(len(bandwidths)):
        filename = f"../../plots/global_warming_bandwidth{b}.png"
...
ax.legend()
plots.save_plot(f"../../plots/global_warming_loocv.png")
plt.close()
