...
# download my current bibliography
wget --quiet --output-document $root_dir/assets/files/WGUnderwood.bib https://github.com/WGUNDERWOOD/wgu-cv/raw/master/WGUnderwood.bib
